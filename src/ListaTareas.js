...
export default function ListaTareas() {
    ...
    const agregarNota = () => {
        ...
        const div_error_fono = document.getElementById("error");
        if (!descripcion){
            div_error_fono.innerHTML = "La descripcion es obligatoria";
            ...
            <form>
                <div className="row my-4">
                    ...
                    <div className="col-lg-3 col-md-4 col-sm-6 mb-4">
                        ...
                        <input ref={descripcionRef} className="form-control" placeholder="Ingrese la descripcion"></input>
                        <div id="error"></div>
                    </div>
